      ...
      <div className="css-1iufzrx">
        <div className="css-62o2z6">
          <footer className="css-n1ampd">
            ...
            <div className="css-1l0w9xw">
              <div className="css-em9in">
                ...
                <a data-testid="footer-link-m2-adgm" className="css-1v2qnox" href="/en_AE/adgm/">
                  <p className="css-7qotk5" type="regular" color="secondaryText">
                    M2 ADGM
                  </p>
                </a>
                <a
            ...
            <p
              className="css-xe812p"
              type="regular"
              color="secondaryText"
              data-testid="footer-label-disclaimer"
            >
              2024 M2 - All rights reserved. M2 Global Wealth Limited is a registered Digital Asset
              Business and is regulated and authorised by the Securities Commission of The Bahamas.
            </p>
          </footer>
        </div>
      </div>
